          ...
          <div className="flex flex-col py-5 flex-1">
            ...
            <div className="flex space-x-2 justify-end flex-1">
              ...
              {result.previous_price > 0 && (
                <p className="font-bold text-indigo-500/50 line-through pt-2 text-xl mx-auto">
            ...
            <div className="flex flex-wrap gap-2 justify-end mt-5">
              {result.features.map(
                (feature) =>
                  !!feature && (
                    <p className="text-xs bg-indigo-500 px-2 py-1 text-white rounded-md" key={feature}>
                      {feature}
                    </p>
                  )
              )}
